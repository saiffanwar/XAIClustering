...
class LimeTabularExplainer(object):
    ...
    def explain_instance(self,
        ...
        for label in labels:
            (ret_exp.intercept[label],
             ...
             ret_exp.weights,
             ret_exp.local_model) = self.base.explain_instance_with_data(
                    scaled_data,
                    yss,
                    distances,
                    label,
        ...
        if self.mode == "regression":
            ...
            perturbations = scaled_data
            model_perturbation_predictions = predict_fn(scaled_data)
            instance_prediction = predict_fn(scaled_data[0].reshape(1, -1))
            exp_instance_prediction = ret_exp.local_pred[0]

        return ret_exp, perturbations, model_perturbation_predictions, exp_perturbation_predictions, instance_prediction, exp_instance_prediction
    ...
    def testing_explain_instance(self,
                                 ...
                                 sampling_method='gaussian',
                                 alpha=0.05):
        """Generates explanations for a prediction. This is a helper function for slime.
